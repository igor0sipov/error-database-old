				...
				<div class="search-result">
					...
					<?php
						...
						if(isset($_POST['search_button'])){
							$search_line = $_POST['fault_search'];

							$command = "SELECT `fault_id`, `fault_name`, `fault_description`, `fault_solve`, `unit_name` FROM `faults` 
							WHERE `fault_name` LIKE '%{$_POST['fault_search']}%' AND `fault_type` LIKE 'Электрика' 
							OR `fault_description` LIKE '%{$_POST['fault_search']}%' AND `fault_type` LIKE 'Электрика' 
							OR `unit_name` LIKE '%{$_POST['fault_search']}%' AND `fault_type` LIKE 'Электрика' 
							OR `fault_solve` LIKE '%{$_POST['fault_search']}%' AND `fault_type` LIKE 'Электрика' ";
