<html>
  <head>
    <link rel="shortcut icon" href="/pics/electrical_ico.png" type="image/x-icon">
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
      <div class="main-content">
          ...
          <header class="header">
            ...
            <a href="el_search.php" class="header-button">Поиск</a>
          </header>
          ...
          <div class="machine-list">
            ...
            <?php
              ...
              if (isset($_POST['show_button'])) {
                ...
                FROM `faults` WHERE `unit_name` = '{$unit_name}' AND `fault_type` ='Электрика' ");
